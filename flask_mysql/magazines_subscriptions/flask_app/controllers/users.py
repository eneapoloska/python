...
def register():
    ...
    flash('User created succesfully!!!', 'signUpSuccessful')
    return redirect(request.referrer)
...
def dashboard():
    ...
    return render_template('dashboard.html', loggedUser= User.get_user_by_id(data), magazines= Magazine.getAllMagazines())